...
random_name() ->
    ...
    First = lists:nth(rand:uniform(length(FisrtSeeds)), FisrtSeeds),
    Second = lists:nth(rand:uniform(length(SecondSeeds)), SecondSeeds),
    string:join([string:titlecase(First), string:titlecase(Second)], " ").
